...
var category = {OBJ: $("#_JD_ALLSORT"),
		URL_Serv: "http://rest.taotao.com:8081/rest/item/cat/list?callback=?",
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://rest.taotao.com:8082" + c + ".html"), '<a href="' + c + '">' + d + "</a>")

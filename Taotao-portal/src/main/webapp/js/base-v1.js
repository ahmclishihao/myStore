 ...
 */
function login() {
    return location.href = "http://sso.taotao.com:8084/login";
}
function regist() {
    return location.href = "http://sso.taotao.com:8084/register";
}
...
function search(a) {
    var b = "http://portal.taotao.com:8082/search?keywords=" + encodeURIComponent(document.getElementById(a).value);

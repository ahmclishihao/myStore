...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img clstag="clickcart|keycount|xincart|logo"
                                    src="/images/taotao-logo.gif" title="返回淘淘商城首页"
                                    alt="返回淘淘商城首页"></a></div>
    ...
    <div id="show">
        ...
        <div class="cart-inner">
            <div class="cart-thead clearfix">
                <div class="column t-checkbox form"><input data-cart="toggle-cb"
            ...
            <div id="product-list" class="cart-tbody">
                ...
                <c:forEach items="${cartList}" var="cart">
                    <c:set var="totalNum" value="${totalNum+(cart.cartItemNum)}"/>
                    <c:set var="totalPrice"
                           value="${ totalPrice + (cart.price * cart.cartItemNum)}"/>
                    <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
                        <div class="item_form clearfix">
                            <div class="cell p-checkbox"><input data-bind="cbid:1" class="checkbox"
                                                                type="checkbox" name="checkItem"
                                                                checked="" value="11345721-1"></div>
                            <div class="cell p-goods">
                                <div class="p-img">
                                    <a href="/item/${cart.id }.html" target="_blank">
                                        <img clstag="clickcart|keycount|xincart|p-imglistcart"
                                             src="${cart.images[0]}" alt="${cart.title}" width="52"
                                             height="52">
                                    </a>
                                </div>
                                <div class="p-name">
                                    ...
                                    <span class="promise411 promise411_11345721"
                                          id="promise411_11345721"></span>
                                </div>
                            </div>
                            <div class="cell p-price"><span class="price">¥<fmt:formatNumber
                            ...
                            <div class="cell p-remove"><a id="remove-11345721-1"
                                                          data-more="removed-87.20-1"
            ...
            <div class="cart-toolbar clearfix">
                ...
                <div class="amout fr"><span
                        id="selectedCount">${empty totalNum  ? "0":totalNum}</span> 种商品
                </div>
            </div>
            <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;">
              ...
              <span class="column t-checkbox form">
                  <input data-cart="toggle-cb" name="toggle-checkboxes" id="toggle-checkboxes_down"
                         type="checkbox" checked="" value="" class="jdcheckbox">
                  ...
                  <a href="javascript:void(0);" clstag="clickcart|keycount|xincart|clearcartlink"
                     id="remove-batch">
                          删除选中的商品
                  </a>
              </span>
                  ...
                  <span class="check-comm-btns" id="checkout-jd">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOverseaOrder();"
                             class="checkout-jdInt">去淘淘国际结算<b></b></a>
